...
namespace Dx29.Web.Areas.Identity.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender, EmailHelper emailHelper)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                bool sendOk = await _emailHelper.SendForgotPasswordEmailAsync(user.Email, user.Language, callbackUrl);
